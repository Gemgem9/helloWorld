...
def analytics_dashboard():
    ...
    df_orders_by_state = df_orders_by_state.sort_values('states')

    orders_by_state_figure = px.pie(df_orders_by_state, names='states', values='order_counts', title='All Orders Segmented by State',
