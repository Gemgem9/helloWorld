...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'giging20', 'email': 'giging20@terpmail.umd.edu', 'first_name': 'Gemma', 'last_name': 'Nguyen',
         'password': generate_password_hash('giging20bmgt407', method='sha256'), 'role': 'STUDENT'},
    ]
